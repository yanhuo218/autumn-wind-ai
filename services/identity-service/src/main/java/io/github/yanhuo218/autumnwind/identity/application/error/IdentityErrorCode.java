...
public enum IdentityErrorCode {
    ...
    INVALID_SERVICE_TOKEN("AW-IDENTITY-AUTH-0003"),
    REGISTRATION_UNAVAILABLE("AW-IDENTITY-DEPENDENCY-0001"),
    VERSION_CONFLICT("AW-IDENTITY-CONFLICT-0001"),
    POLICY_UNAVAILABLE("AW-IDENTITY-INTERNAL-0001"),
    ACCESS_DENIED("AW-IDENTITY-FORBIDDEN-0002"),
    INTERNAL_ERROR("AW-IDENTITY-INTERNAL-0002");
