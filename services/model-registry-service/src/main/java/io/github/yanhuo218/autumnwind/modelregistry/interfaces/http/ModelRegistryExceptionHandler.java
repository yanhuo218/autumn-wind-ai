...
public class ModelRegistryExceptionHandler {
    ...
    private static HttpStatus statusFor(ModelRegistryErrorCode code) {
        return switch (code) {
            ...
            case ENDPOINT_VERSION_CONFLICT, ENDPOINT_TEST_UNAVAILABLE, INFERENCE_TARGET_UNAVAILABLE,
                    CONNECTION_TEST_LEASE_CONFLICT, MODEL_CONFLICT, DEFAULT_MODEL_CONFLICT,
